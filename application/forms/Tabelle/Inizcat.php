...
class Form_Tabelle_Inizcat extends Form_Myform
{
    ...
    public function init()
    {
        ...
        // Legislazione1
        $tmpElem = new Zend_Form_Element_TextArea('Legislazione1',
            array('rows'=>3));
        $tmpElem->setLabel('Leg. primo limite');
        $tmpElem->setDecorators($this->elementDecorators);
        $this->addElement($tmpElem);
        ...
        // Legislazione2
        $tmpElem = new Zend_Form_Element_TextArea('Legislazione2',
            array('rows'=>3));
        $tmpElem->setLabel('Leg. secondo limite');
        $tmpElem->setDecorators($this->elementDecorators);
        $this->addElement($tmpElem);
