 ...
 * @version    $Id: Table.php 1515 2010-12-13 16:48:59Z bento.vilas.boas@gmail.com $
...
// Italo class=subtitulo
    
    public function filtersLoop ()
    {
        return "        <td class=\"subtitulo\" {{colspan}}  ".$this->getClass('filters')."  >{{value}}</td>" . PHP_EOL;
    }
