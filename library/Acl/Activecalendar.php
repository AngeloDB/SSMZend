...
********************************************************************************
*/
    function acl_activeCalendar($year=false,$month=false,$day=false,$GMTDiff="none")
    {
        $this->timetoday=time();
        $this->selectedday=-2;
...
*/
    function mkMonthTitle()
    {
        ...
        {
            $out.="<tr><td class=\"".$this->cssMonthNav."\" >";
            $out.=$this->mkUrl($this->actyear-1,$this->actmonth);
            $out.=$this->monthNavBack.($this->actyear-1)."</a></td>";
            ...
            $out.="<td class=\"".$this->cssMonthNav."\" >";
            $out.=$this->mkUrl($this->actyear+1,$this->actmonth);
            $out.=($this->actyear+1).$this->monthNavForw."</a></td></tr>\n";
        }
        return $out;
    }
/*
